...
export default async function StudentDashboardPage() {
  ...
  // Debug: Log the missing documents data
  console.log('Dashboard - Missing documents count:', dashboardData?.missingDocuments?.length);
  console.log('Dashboard - Missing documents:', dashboardData?.missingDocuments);
