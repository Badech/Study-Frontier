/**
 * Parent signup page
 * Allows parents/sponsors to create accounts
 */
...
export default async function ParentSignupPage(props: {
  ...
  return (
    <div className="rounded-lg border border-border bg-card p-8 shadow-lg">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold mb-2">Parent Account</h1>
        <p className="text-muted-foreground">
          Create a parent account to view your student's progress
        </p>
      </div>
